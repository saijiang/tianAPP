 ...
 *
 */
@property(nonatomic) UIColor*  leftlineWithColor;
 ...
 *
 */
@property(nonatomic) UIColor*  toplineWithColor;

/**
 *  右边线
 *
 */
@property(nonatomic) UIColor*  rightlineWithColor;
 ...
 *
 */
@property(nonatomic) UIColor*  bottomlineWithColor;
