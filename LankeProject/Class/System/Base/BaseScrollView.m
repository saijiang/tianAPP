...
//                  animated:YES];
    ...
    [self scrollViewContentOffset:firstResponder];

    [UIView commitAnimations];
}


-(void)scrollViewContentOffset:(UIView *)firtResponder
{
    [self setContentOffset:CGPointMake(self.contentOffset.x,
                                       [self idealOffsetForView:firtResponder withSpace:[self keyboardRect].origin.y - self.bounds.origin.y])
                  animated:YES];
}
