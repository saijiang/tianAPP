//
//  SelfSupportGoodsDetailViewController.m
//  LankeProject
//
...
@interface SelfSupportGoodsDetailViewController ()<UITableViewDataSource,UITableViewDelegate,CAAnimationDelegate>
...
@implementation SelfSupportGoodsDetailViewController
...
- (void) creatUI{
    ...
    _shyNavigationBar.bBackButtonHandle = ^(){
        LKStrongSelf
        _self.navigationController.navigationBarHidden = NO;
...
//            [_self.navigationController pushViewController:cartList animated:YES];
    ...
    __block SelfSupportGoodsDetailViewController *manager = self;
...
- (UIView *) tableViewHeaderView{
    ...
    _headerView.frame = CGRectMake(0, 0, DEF_SCREEN_WIDTH, DEF_SCREEN_WIDTH + 140);
...
-(void)updateBuyButton
{
    ...
    if (self.headerView.stepView.value*[self.goodsDetailData[@"couponPrice"] floatValue]>[self.goodsDetailData[@"startSendMoney"] floatValue]) {
        
        self.bottomView.ImmediatelyBuyButton.enabled=YES;
        
    }else{
        
        self.bottomView.ImmediatelyBuyButton.enabled=NO;
...
- (NSArray *) formatterOrderData{
    ...
    NSDictionary * data = @{@"expressDeliveryFee":NSStringWithData(self.goodsDetailData[@"expressDeliveryFee"]),
                            ...
                            @"freeSendMoney":NSStringWithData(self.goodsDetailData[@"freeSendMoney"]),
                            @"startSendMoney":NSStringWithData(self.goodsDetailData[@"startSendMoney"]), @"merchantDeliveryFlg":NSStringWithData(self.goodsDetailData[@"merchantDeliveryFlg"]),
                            ...
                            @"startSendMoney":NSStringWithData(self.goodsDetailData[@"startSendMoney"]),
                            @"freeSendMoney":NSStringWithData(self.goodsDetailData[@"freeSendMoney"]),
                            @"startSendFlg":NSStringWithData(self.goodsDetailData[@"startSendFlg"]),
                            @"freeSendFlg":NSStringWithData(self.goodsDetailData[@"freeSendFlg"]),
...
- (void) navigationToShopInfo{
    ...
    if (self.isSorce) {
        ...
        shopInfo.webData=self.goodsDetailData;
