...
@interface HLLPickView ()<UITableViewDataSource,UITableViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
- (void) configFlowLayout:(UICollectionViewFlowLayout *)layout{
    ...
    CGFloat width = (DEF_SCREEN_WIDTH - kSectionViewWidth);
    CGFloat height = 100;
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    ...
    if (self.dataSource && [self.dataSource respondsToSelector:@selector(pickView:numberOfRowsInSection:)]) {
        ...
        numberOfItemsInSection = [self.dataSource pickView:self numberOfRowsInSection:self.selectedSectionIndex];
    }
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.dataSource && [self.dataSource respondsToSelector:@selector(pickView:viewForRowAtIndexPath:)]) {
        ...
        NSIndexPath * selectIndexPath = [NSIndexPath indexPathForItem:indexPath.item inSection:self.selectedSectionIndex];
        
        UICollectionViewCell * cell = [self.dataSource pickView:self viewForRowAtIndexPath:selectIndexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(pickView:didPickRowAtIndexPath:)]) {
        ...
        [self.delegate pickView:self didPickRowAtIndexPath:selectIndexPath];
    }
