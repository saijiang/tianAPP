...
@interface JDShopLogisticsDetailsView ()<UITableViewDelegate,UITableViewDataSource>

@property(nonatomic,strong)UITableView *tableCtrl;
@property(nonatomic,strong)LogisticsHeaderView *headerView;
@property(nonatomic,strong)NSDictionary *dataSource;
@property(nonatomic,strong)NSMutableArray *logisticsDetailList;

@end

@implementation JDShopLogisticsDetailsView
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        self.logisticsDetailList = [[NSMutableArray alloc]init];
        [self createUI];
    }
    return self;
}
...
{
    return [LogisticsCell getJDshopCellHightWithDatasource:self.logisticsDetailList[indexPath.row]];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell loadJDshopCellWithDataSource:self.logisticsDetailList[indexPath.row]];
    return cell;
}
...
-(void)loadViewWithDataSource:(id)dataSource
{
    ...
    [self.logisticsDetailList addObjectsFromArray:dataSource];
