...
@interface GoodsCollectionViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource>
...
{
    [UserServices
     getGoodsCollectWithUserId:[KeychainManager readUserId]
     pageIndex:@"1"
     pageSize:@"1000"
...
{
    GoodsCollectionCell *cell=[GoodsCollectionCell cellWithTableView:tableView];
