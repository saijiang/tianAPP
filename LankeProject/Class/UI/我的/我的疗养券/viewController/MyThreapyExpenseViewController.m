//
//  MyThreapyExpenseViewController.m
//  LankeProject
//
...
@interface MyThreapyExpenseViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    NSArray *testArray;
}
...
@implementation MyThreapyExpenseViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell loadThearyCellUserDetailsWithDataSource:testArray[indexPath.row]];
...
-(void)getTherapyDetail
{
    [UserServices getThreapayDetailWithuserId:[KeychainManager readUserId] completionBlock:^(int result, id responseObject) {
        if (result==0)
        {
