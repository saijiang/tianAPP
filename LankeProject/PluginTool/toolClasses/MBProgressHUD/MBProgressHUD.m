...
- (void)layoutSubviews {
    ...
    NSDictionary *attrDict = [NSDictionary dictionaryWithObjectsAndKeys:
                              ...
                              nil];
    CGRect lblRect = [label.text boundingRectWithSize:(CGSize){labelSize.width - 20, MAXFLOAT}
                                              options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading
                                           attributes:attrDict
                                              context:nil];	totalSize.width = MAX(totalSize.width, labelSize.width);
    labelSize.height = lblRect.size.height;
...
{
//    UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"提示" message:@"是否要取消请求" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
//    [alert show];
//    [alert release];
//    [[DataHander sharedDataHander] cancelRequest];
}
