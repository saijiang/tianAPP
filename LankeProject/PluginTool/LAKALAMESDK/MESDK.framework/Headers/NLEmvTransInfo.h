...
typedef enum
{
    NLEmvTransPinInputType_OFFLINE, /* 脱机密码 */
    NLEmvTransPinInputType_OFFLINE_ONLY, /* 最后一次脱机密码 */
    NLEmvTransPinInputType_ONLINE, /* 联机密码 */
    NLEmvTransPinInputType_EC_ONLINE /* 电子现金阈值超出联机密码 */
}NLEmvTransPinInputType;
...
@property (nonatomic, strong) NSString* appVersionNumberTerminal;
...
@property (nonatomic, strong) NSData * ecashdetails;
...
//@property (nonatomic, strong) NSData *random_num;
@property (nonatomic, strong) NSData *aid_terminal;
@property (nonatomic, strong) NSDictionary * aidItems;
@property (nonatomic) NLEmvTransPinInputType emvPinInputType;
- (BOOL)isNeedOnLinePin;
@end
