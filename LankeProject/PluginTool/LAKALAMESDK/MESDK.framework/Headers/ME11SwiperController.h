...
#import <MESDK/MESwiperController.h>
 ...
 */
@interface ME11SwiperController : NSObject<CSwiperControllerEmvOperator, CSwiperControllerStorageOperator> {
}
/*!
 @property delegate
...
@interface CSwiperParameter (ME11)
