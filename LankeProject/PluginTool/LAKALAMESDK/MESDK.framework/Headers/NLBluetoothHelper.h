 ...
 */
+ (NSDictionary*)devicePeripherals;
/*!
 @method
 @abstract 开始扫描
 @discussion
...
/*!
 @method
 @abstract 扫描外围设备与历史设备
 @discussion
 */
+ (void)starScanAllDevices;
/*!
 @method
...
/*!
 @method
 @abstract 根据uuid获取mac地址
 @discussion
 @param duration 设备uuid
 @return 设备mac地址
 */
+(NSString*)fetchDeviceMACWithUUID:(NSString*)uuid;
/*!
 @method
 @abstract 根据uuid获取设备名称
 @discussion
 @param duration 设备uuid
 @return 设备名称
 */
+(NSString*)fetchDeviceNameWithUUID:(NSString*)uuid;
/*!
 @method
 @abstract 根据uuid获取蓝牙设备信号强度
 @discussion
 @param duration 设备uuid
 @return 蓝牙信号强度
 */
+(NSNumber*)fetchDeviceRSSIWithUUID:(NSString*)uuid;
@end
