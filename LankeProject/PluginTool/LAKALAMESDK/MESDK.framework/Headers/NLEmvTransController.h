 ...
 */
- (void)startEmvWithProcessingCode:(int)processingCode innerProcessingCode:(int)innerProcessingCode amount:(NSDecimalNumber*)amount forceOnline:(BOOL)forceOnline error:(NSError**)err;
 ...
 * @param forceOnline 强制联机
 */
- (void)startEmvWithAmount:(NSDecimalNumber*)amount cashback:(NSDecimalNumber*)cashback forceOnline:(BOOL)forceOnline error:(NSError**)err;
 ...
 * 取消emv交易<p>
 *
 * @param isSuccess 是否为成功结束EMV流程
 */
- (void)cancelEmv:(BOOL)isSuccess;
