...
@interface EHHorizontalSelectionView () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)setScrollEnabled:(BOOL)scrollEnabled{
    ...
    [_collectionView setScrollEnabled:scrollEnabled];
    [_collectionView setAlwaysBounceHorizontal:scrollEnabled];
}
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([_class useDynamicSize])
    {
        ...
        if (_maxDisplayCount != NSIntegerMin) {
            return CGSizeMake(DEF_SCREEN_WIDTH / _maxDisplayCount, frame.size.height);
        }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_normalTextColor)
    {
        [cell setNormalTextColor:_normalTextColor];
    }
    
    if (_selectTextColor)
    {
        [cell setSelectTextColor:_selectTextColor];
    }
