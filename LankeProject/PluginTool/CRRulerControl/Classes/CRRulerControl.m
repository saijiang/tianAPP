...
static const CGSize  kPointerImageViewSize = {2, 40};
...
- (CGRect)frameForPointerImageView {
    ...
    CGFloat pointerImageViewOriginY = 0;//(self.frame.size.height - kPointerImageViewSize.height) / 2;
...
- (CGFloat)offsetCoefficient {
    ...
    return (self.scrollView.contentSize.width - kSideOffset * 2.0) / distance;
}
